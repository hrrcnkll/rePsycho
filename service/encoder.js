...
// Sourse: https://github.com/VKCOM/vk-apps-launch-params#node
...
module.exports = (params) => {
    ...
    const launchParams = params.slice(params.indexOf('?') + 1);
    ...
    if (areLaunchParamsValid) {
        ...
        // Number((params.match(/vk_user_id=[0-9]*/g))[0].replace('vk_user_id=', ''))
    }
    else {
